...
class ClinicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clinic" do
    assert_difference('Clinic.count') do
      post clinics_url, params: { clinic: { county: @clinic.county, district: @clinic.district, name: @clinic.name, parish: @clinic.parish, street: @clinic.street } }
    end
  ...
  test "should update clinic" do
    patch clinic_url(@clinic), params: { clinic: { county: @clinic.county, district: @clinic.district, name: @clinic.name, parish: @clinic.parish, street: @clinic.street } }
